...

{
...

    {
        ...
        /** Make an object of StrassenMultiplication class **/
        ...
        for (int i = 0; i < N; i++)
            ...
            for (int j = 0; j < N; j++)
                ...
                B[i][j] = randNum.nextInt(100); //scan.nextInt();
        ...
        System.out.println(" \n \n Time taken to multiply matrix of size : " + N +" is " + totalTime + " ns \n \n");
